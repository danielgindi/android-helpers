...
@Suppress("unused")
class TextInputEditTextEx : TextInputEditText
{
    ...
    private fun setCustomFontFamily(context: Context, attrs: AttributeSet)
    {
        ...
        try
        {
            styledAttributes = context.obtainStyledAttributes(attrs, R.styleable.TextInputEditTextEx)
            fontFamily = styledAttributes!!.getString(R.styleable.TextInputEditTextEx_customFontFamily)
        }
        finally
        {
